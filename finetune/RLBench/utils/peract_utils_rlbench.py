...
DATA_FOLDER="/common-data/dataset/RLBench/BridgeVLA_RLBench_TRAIN_DATA"
TRAIN_REPLAY_STORAGE_DIR = "/common-data/dataset/RLBench/BridgeVLA_RLBench_TRAIN_Buffer" # path to save buffer
